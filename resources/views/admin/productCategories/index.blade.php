					...
					<table class="table table-bordered">
						...
						@forelse($categories as $key => $category)
							<tr>
								...
								<td>
									<form action="{{ route('admin.article-category.destroy', $category) }}" onsubmit="if(confirm('Удалить?')){ return true }else{ return false}" method="post">
										@csrf
										<input type="hidden" name="_method" value="DELETE">

										<a href="{{ route('admin.article-category.edit', [$category]) }}" class="btn btn-default"><i class="fas fa-edit"></i></a>
